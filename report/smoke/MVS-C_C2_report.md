...
- θ=(256, 1.2) H=48：CMDP* E[B]=26.875（V_lag=85.0 仅作 solve 证书；memo=3073、expansions=3073、0.1s）；Phase-FG exact C=27.125（rel=0.93%）、Myopic 26.875（0.00%）、Direct4 27.500（2.33%）
- θ=(256, 1.2) H=96：CMDP* E[B]=34.569（V_lag=80.3 仅作 solve 证书；memo=607890、expansions=607890、16.5s）；Phase-FG exact C=29.896（rel=-13.52%）、Myopic 29.775（-13.87%）、Direct4 31.176（-9.82%）
...
- θ=(512, 1.2) H=96：CMDP* E[B]=38.712（V_lag=124.6 仅作 solve 证书；memo=607890、expansions=607890、16.8s）；Phase-FG exact C=36.877（rel=-4.74%）、Myopic 36.518（-5.67%）、Direct4 36.055（-6.86%）
- θ=(1024, 1.6) H=48：CMDP* E[B]=30.938（V_lag=287.9 仅作 solve 证书；memo=3073、expansions=3073、0.1s）；Phase-FG exact C=31.062（rel=0.40%）、Myopic 32.500（5.05%）、Direct4 31.250（1.01%）
- θ=(1024, 1.6) H=96：CMDP* E[B]=44.483（V_lag=234.3 仅作 solve 证书；memo=607890、expansions=607890、16.5s）；Phase-FG exact C=40.974（rel=-7.89%）、Myopic 43.109（-3.09%）、Direct4 40.121（-9.81%）
- θ=(128, 2.0) H=48：CMDP* E[B]=24.500（V_lag=63.7 仅作 solve 证书；memo=3073、expansions=3073、0.1s）；Phase-FG exact C=0.000（rel=-100.00%）、Myopic 0.000（-100.00%）、Direct4 0.000（-100.00%）
- θ=(128, 2.0) H=96：CMDP* E[B]=27.826（V_lag=62.4 仅作 solve 证书；memo=607890、expansions=607890、16.6s）；Phase-FG exact C=0.000（rel=-100.00%）、Myopic 0.000（-100.00%）、Direct4 0.000（-100.00%）
